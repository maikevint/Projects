...
public class PQ1_Grader {
    public static void main(String [] args) {
        PriorityQueue<Integer> pq = new BinaryHeapPriorityQueue<Integer>(10);
        System.out.println("Grading the BinaryHeapPriorityQueue implementation");
        try {
            for(int i=10; i > 0; i--)
                if(!pq.insert(i))
        ...
        pq.clear();
        pq = new BinaryHeapPriorityQueue<Integer>(100);            
        try {
            for(int i=0; i < 100; i++)
        ...
        try {
            pq = new BinaryHeapPriorityQueue<Integer>(500);
            for(int i=0; i < 5; i++)
                for(int j=0; j < 100; j++)
                    if(!pq.insert(j))
        ...
        try {
            PriorityQueue<Item> pq2 = new BinaryHeapPriorityQueue<Item>(6);
         ...
         try {
            PriorityQueue<Item> pq2 = new BinaryHeapPriorityQueue<Item>(10);
            int sequence = 0;
            for(int i=0; i < 10; i++) {
